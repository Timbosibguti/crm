...
// Функция для получения данных от Roi API
async function fetchRoiLeads() {
  try {
    ...
    console.error('Error fetching data from Roi API:', error.message);
  }
}
fetchRoiLeads();
